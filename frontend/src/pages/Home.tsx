...
export default function Home() {
  ...
  // Set your local frontend image path here
  const localHeroImage = "/images/home-hero.webp";

  return (
    <>
      {/* 1. Hero — reduced vertical padding here */}
 {/* 1. Hero */}
      ...
      {hero.data && (
        <section
          ...
          style={{ backgroundImage: `url(${localHeroImage})` }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-blue-dark/95 via-blue-dark/70 to-blue-dark/20" />
          ...
          <div className="container-page relative py-12 lg:py-16">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-4 leading-tight text-white">
              ...
              {hero.data.subtitle && (
                <p className="mt-4 max-w-lg text-base leading-relaxed text-white/80">{hero.data.subtitle}</p>
              )}
